...
require "direitos_autorais/version"

Gem::Specification.new do |spec|
  spec.name          = "direitos_autorais"
  spec.version       = DireitosAutorais::VERSION
  ...
  spec.homepage      = "https://github.com/Ceobaniuc/direitos_autorais.git"
